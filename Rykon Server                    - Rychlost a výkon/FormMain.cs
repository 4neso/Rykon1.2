...
namespace RykonServer
{
    public partial class FormMain : Form
    {
        ...
        private async Task StartServer()
        {
            ...
            if (this.ServerConfiguration.EnableControler)
                ViewLog("Control from " + SelectedPrefix + "/Control/");

            if (this.ServerConfiguration.EnableVideos)
                ViewLog("Video from " + SelectedPrefix + "/Video/");

            if (this.ServerConfiguration.EnableListen)
            ...
            while (_Listening_)
            {
                try
                {
                    ...
                    cp.CanConnect = (this.ServerConfiguration.IsPublicServer);
                    ...
                    try
                    {
                        ...
                        if (!this.ServerConfiguration.IsPublicServer)
                            CanConnect = WebServer.CheckBasicAuth(ctx.Request.Headers["Authorization"], ServerConfiguration.ServerAuthId, ServerConfiguration.ServerAutPass);
        ...
        private void LoadServerConfiguration()
        {
           ...
           _isPrivateTask= cp_private.Checked = !ServerConfiguration.IsPublicServer;
            txbxServerPass.Text = ServerConfiguration.ServerAutPass;
            TxbxServerId.Text = ServerConfiguration.ServerAuthId;
        ...
        private void ChangeControlerS()
        {
            ...
            privateToolStripMenuItem.Checked = !ServerConfiguration.IsPublicServer;
            publicToolStripMenuItem.Checked = ServerConfiguration.IsPublicServer;
        ...
        private void textBoxUrlStreamer_TextChanged(object sender, EventArgs e)
        {
            ...
            strmlbl.Text = "Streamer available on " + textBoxUrlStreamer;
        }
        ...
        {
            LookForTabPAge(tabControlMain, tabpage_Controller);
        }
...
public string AuthToke=""; 
        ...
        private void privateToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (privateToolStripMenuItem.Checked)
                ServerConfiguration.IsPublicServer = true;
        }
        ...
        private void cp_public_CheckedChanged(object sender, EventArgs e)
        {
            panel_server_credit.Enabled = cp_private.Checked;
            publicToolStripMenuItem.Checked = ServerConfiguration.IsPublicServer = !cp_private.Checked;
            privateToolStripMenuItem.Checked = !publicToolStripMenuItem.Checked;
        ...
        {
            this.ServerConfiguration.ServerAuthId = TxbxServerId.Text;

        }

        private void txbxServerPass_TextChanged(object sender, EventArgs e)
        {
            this.ServerConfiguration.ServerAutPass = txbxServerPass.Text;
        }
        ...
        {
            LookForTabPAge(tabControlMain, tpg_Video);

        }

        private void viewRListenToolStripMenuItem_Click(object sender, EventArgs e)
        {
            LookForTabPAge(tabControlMain, tbpg_listen);
        }

        private void cbSecureControl_CheckedChanged(object sender, EventArgs e)
        {
            this._SecuredControler_ = cbSecureControl.Checked;
        }

        public bool _SecuredControler_ { get; set; }
        ...
        {
            ServerConfiguration.RootDirectory = txbxRootDir.Text;
        }
